# Contributing to AumAI Toolsmith
...
### Setup
```bash
git clone https://github.com/aumai/aumai-toolsmith.git
cd aumai-toolsmith
python -m venv .venv
...
### Good First Issues
New to the project? Start with issues labeled [`good first issue`](https://github.com/aumai/aumai-toolsmith/labels/good%20first%20issue).
...
- [GitHub Discussions](https://github.com/aumai/aumai-toolsmith/discussions)
